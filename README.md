...
This case study is the capstone project of the [Google Data Analytics Professional Certificate program](https://www.coursera.org/professional-certificates/google-data-analytics). The scenario involves analyzing the trip data for a bikeshare company in Washington DC. 
